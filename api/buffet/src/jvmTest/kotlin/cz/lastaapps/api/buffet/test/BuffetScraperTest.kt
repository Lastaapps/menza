...
class BuffetScraperTest : StringSpec({
    ...
    "Scrape 2023-01-23" {
        ...
        fel[4].dishList[3].run { // is not in a <strong> tag
            ...
            price shouldBe 104
            ingredients shouldBe listOf(
                "špagety", "česnek", "olivový olej", "feferonky", "parmazán"
            )
        }
    }
    ...
    "Scrape 2023-01-30" {
        ...
        fs[2].dishList[1].run {
            ...
            price shouldBe 128
            ingredients shouldBe listOf(
                "vepřové a kuřecí maso", "cibule", "slanina", "klobása",
            )
        }
        ...
        fel[0].dishList[1].run { // is not in a <strong> tag
            ...
            price shouldBe 119
            ingredients shouldBe listOf(
                "kuřecí maso", "niva", "smetana", "směs koření",
            )
        }
    }
    ...
    "Scrape 2023-02-20" {
        ...
        fel[3].dishList[1].run { // is not in a <strong> tag
            ...
            price shouldBe 119
            ingredients shouldBe listOf(
                "kuřecí maso", "marináda", "baby karotka"
            )
        }
    }
})
