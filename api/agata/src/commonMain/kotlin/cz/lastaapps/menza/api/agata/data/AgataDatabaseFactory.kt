...
internal object AgataDatabaseFactory {
    ...
    fun createDatabase(
        ...
        DishTypeEntityAdapter = DishTypeEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
        InfoEntityAdapter = InfoEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
        LinkEntityAdapter = LinkEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
        NewsEntityAdapter = NewsEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
        ...
        PictogramEntityAdapter = PictogramEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
        ServingPlaceEntityAdapter = ServingPlaceEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
        ...
        SubsystemEntityAdapter = SubsystemEntity.Adapter(
            languageAdapter = LanguageAdapter,
        ),
...
private object LanguageAdapter : ColumnAdapter<DBLang, String> {
    override fun decode(databaseValue: String): DBLang =
        DBLang.entries.first { it.value == databaseValue }
