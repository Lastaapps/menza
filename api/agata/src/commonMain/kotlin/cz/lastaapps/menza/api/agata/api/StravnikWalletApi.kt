...
internal class StravnikWalletApiImpl(
    ...
    private suspend fun login(username: String, password: String) = catchingNetwork {
        log.i { "Logging in" }
        client.submitForm(
    ...
    private suspend fun getData() = catchingNetwork {
        log.i { "Getting data" }
        client.get("$domain/Transactions/NoSSO")
    }

    private suspend fun logout() = catchingNetwork {
        log.i { "Logging out" }
