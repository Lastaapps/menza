...
class LocationScraperMock(val set: Set<MenzaLocation>) : LocationScraper<Any> {
    override suspend fun createRequest() = Any()

    override fun scrape(result: Any): Set<MenzaLocation> = set

    override fun scrape(html: String): Set<MenzaLocation> = set
}