...
class MessagesScraperMock(val set: Set<Message>) : MessagesScraper<Any> {
    override suspend fun createRequest() = Any()

    override fun scrape(result: Any): Set<Message> = set

    override fun scrape(html: String): Set<Message> = set
}
